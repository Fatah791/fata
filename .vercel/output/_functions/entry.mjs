...
var middlewareSecret = "75352967-25d5-4b9d-92cb-1f8947be6c9a";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			OS: "Windows_NT",
			Path: "D:\\best\\fata.worktrees\\existential-questions\\node_modules\\.bin;D:\\best\\fata.worktrees\\existential-questions\\node_modules\\.bin;D:\\best\\fata.worktrees\\node_modules\\.bin;D:\\best\\node_modules\\.bin;D:\\node_modules\\.bin;C:\\Program Files\\nodejs\\node_modules\\npm\\node_modules\\@npmcli\\run-script\\lib\\node-gyp-bin;c:\\Users\\tarahi\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\debugCommand;c:\\Users\\tarahi\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\copilotCli;C:\\Python314\\Scripts\\;C:\\Python314\\;C:\\Program Files\\Python313\\Scripts\\;C:\\Program Files\\Python313\\;C:\\WINDOWS\\system32;C:\\WINDOWS;C:\\WINDOWS\\System32\\Wbem;C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\;C:\\WINDOWS\\System32\\OpenSSH\\;C:\\Program Files (x86)\\Bitvise SSH Client;C:\\Program Files\\PuTTY\\;E:\\Microsoft VS Code\\bin;C:\\Program Files\\nodejs\\;C:\\ProgramData\\chocolatey\\bin;C:\\Program Files\\Tailscale\\;C:\\Program Files\\Git\\cmd;C:\\Users\\tarahi\\.mimocode\\bin;C:\\Users\\tarahi\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\tarahi\\AppData\\Roaming\\npm;c:\\Users\\tarahi\\.vscode\\extensions\\ms-python.debugpy-2026.6.0-win32-x64\\bundled\\scripts\\noConfigScripts"
		})?.PROD) return {
...
var _page0 = () => import("./chunks/generic_B50kW01Y.mjs");
var _page1 = () => import("./chunks/keystatic-api_dHXQo3Vp.mjs");
var _page2 = () => import("./chunks/keystatic-astro-page_Dwyn0o72.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///D:/best/fata.worktrees/existential-questions/","cacheDir":"file:///D:/best/fata.worktrees/existential-questions/node_modules/.astro/","outDir":"file:///D:/best/fata.worktrees/existential-questions/dist/","srcDir":"file:///D:/best/fata.worktrees/existential-questions/src/","publicDir":"file:///D:/best/fata.worktrees/existential-questions/public/","buildClientDir":"file:///D:/best/fata.worktrees/existential-questions/dist/client/","buildServerDir":"file:///D:/best/fata.worktrees/existential-questions/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"endpoint","isIndex":false,"route":"/api/keystatic/[...params]","pattern":"^\\/api\\/keystatic(?:\\/(.*?))?\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"keystatic","dynamic":false,"spread":false}],[{"content":"...params","dynamic":true,"spread":true}]],"params":["...params"],"component":"node_modules/@keystatic/astro/internal/keystatic-api.js","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"external","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","isIndex":false,"route":"/keystatic/[...params]","pattern":"^\\/keystatic(?:\\/(.*?))?\\/?$","segments":[[{"content":"keystatic","dynamic":false,"spread":false}],[{"content":"...params","dynamic":true,"spread":true}]],"params":["...params"],"component":"node_modules/@keystatic/astro/internal/keystatic-astro-page.astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"external","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/posts/[slug]","isIndex":false,"type":"page","pattern":"^\\/posts\\/([^/]+?)\\/?$","segments":[[{"content":"posts","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/posts/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/best/fata.worktrees/existential-questions/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/best/fata.worktrees/existential-questions/src/pages/posts/[slug].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BFpz_MaX.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_COfpNgbX.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/posts/[slug]@_@astro":"chunks/_slug__C3ZN0urD.mjs","\u0000virtual:astro:get-image":"chunks/_virtual_astro_get-image_CrgGA2Y_.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","D:\\best\\fata.worktrees\\existential-questions\\.astro\\content-assets.mjs":"chunks/content-assets_DXqEyLLP.mjs","D:\\best\\fata.worktrees\\existential-questions\\.astro\\content-modules.mjs":"chunks/content-modules_I7QRxwaA.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DKE1DfMY.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","D:/best/fata.worktrees/existential-questions/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_Dpx67Otj.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_B50kW01Y.mjs","\u0000virtual:astro:page:node_modules/@keystatic/astro/internal/keystatic-api@_@js":"chunks/keystatic-api_dHXQo3Vp.mjs","\u0000virtual:astro:page:node_modules/@keystatic/astro/internal/keystatic-astro-page@_@astro":"chunks/keystatic-astro-page_Dwyn0o72.mjs","D:/best/fata.worktrees/existential-questions/src/components/ui/Accordion.astro?astro&type=script&index=0&lang.ts":"_astro/Accordion.astro_astro_type_script_index_0_lang.DUxhrizt.js","D:/best/fata.worktrees/existential-questions/src/components/ui/Dropdown.astro?astro&type=script&index=0&lang.ts":"_astro/Dropdown.astro_astro_type_script_index_0_lang.DZ64iXDR.js","D:/best/fata.worktrees/existential-questions/src/components/Header.astro?astro&type=script&index=0&lang.ts":"_astro/Header.astro_astro_type_script_index_0_lang.BlM96Unz.js","D:/best/fata.worktrees/existential-questions/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts":"_astro/Layout.astro_astro_type_script_index_0_lang.uT4wnMcS.js","D:/best/fata.worktrees/existential-questions/src/components/ui/Modal.astro?astro&type=script&index=0&lang.ts":"_astro/Modal.astro_astro_type_script_index_0_lang.C6Xf11vA.js","D:/best/fata.worktrees/existential-questions/src/components/Search.astro?astro&type=script&index=0&lang.ts":"_astro/Search.astro_astro_type_script_index_0_lang.C-Nvky1m.js","D:/best/fata.worktrees/existential-questions/src/components/ui/Tabs.astro?astro&type=script&index=0&lang.ts":"_astro/Tabs.astro_astro_type_script_index_0_lang.zpJ3xQSq.js","D:/best/fata.worktrees/existential-questions/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts":"_astro/ThemeToggle.astro_astro_type_script_index_0_lang._uy9L4uP.js","D:/best/fata.worktrees/existential-questions/src/components/ThemeToggle.astro?astro&type=script&index=1&lang.ts":"_astro/ThemeToggle.astro_astro_type_script_index_1_lang.BEM7GmjE.js","D:/best/fata.worktrees/existential-questions/src/components/ui/Tooltip.astro?astro&type=script&index=0&lang.ts":"_astro/Tooltip.astro_astro_type_script_index_0_lang.Bn3-YNnv.js","D:/best/fata.worktrees/existential-questions/node_modules/@keystatic/astro/internal/keystatic-page.js":"_astro/keystatic-page.lsjIxpR9.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/best/fata.worktrees/existential-questions/src/components/ui/Accordion.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelectorAll(`[data-accordion-item]`),n=e.querySelectorAll(`[data-accordion-trigger]`);function r(e){let n=e.target.closest(`details`);n&&(allowMultiple||t.forEach(e=>{e!==n&&e.open&&e.removeAttribute(`open`)}))}n.forEach(e=>{e.addEventListener(`click`,r)}),n.forEach(e=>{e.addEventListener(`keydown`,e=>{e.key===`Enter`||e.key})})})();"],["D:/best/fata.worktrees/existential-questions/src/components/ui/Dropdown.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelector(`[data-dropdown-trigger]`),n=e.querySelector(`[data-dropdown-menu]`),r=e.querySelectorAll(`[data-dropdown-item]`),i=!1;function a(){i=!0,n?.classList.remove(`hidden`),t?.setAttribute(`aria-expanded`,`true`),document.addEventListener(`click`,c),document.addEventListener(`keydown`,l)}function o(){i=!1,n?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`),document.removeEventListener(`click`,c),document.removeEventListener(`keydown`,l)}function s(){i?o():a()}function c(t){e.contains(t.target)||o()}function l(e){if(!i)return;let n=Array.from(r).filter(e=>!e.hasAttribute(`disabled`)),a=n.findIndex(e=>e===document.activeElement);switch(e.key){case`Escape`:o(),t?.focus();break;case`ArrowDown`:e.preventDefault(),n[(a+1)%n.length]?.focus();break;case`ArrowUp`:e.preventDefault(),n[(a-1+n.length)%n.length]?.focus();break;case`Enter`:case` `:e.preventDefault(),document.activeElement?.click(),o();break;case`Tab`:o()}}t?.addEventListener(`click`,s),r.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-value`);t&&onChange&&onChange(t),o()})})})();"],["D:/best/fata.worktrees/existential-questions/src/components/Header.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.getElementById(`menu-toggle`),t=document.getElementById(`mobile-menu`);if(!e||!t)return;function n(){t.classList.remove(`hidden`),e.setAttribute(`aria-expanded`,`true`),document.body.style.overflow=`hidden`,t.querySelector(`.mobile-nav-link`)?.focus()}function r(){t.classList.add(`hidden`),e.setAttribute(`aria-expanded`,`false`),document.body.style.overflow=``,e.focus()}e.addEventListener(`click`,()=>{t.classList.contains(`hidden`)?n():r()}),t.addEventListener(`click`,e=>{e.target===t&&r()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!t.classList.contains(`hidden`)&&r()}),t.querySelectorAll(`.mobile-nav-link`).forEach(e=>{e.addEventListener(`click`,r)})})();"],["D:/best/fata.worktrees/existential-questions/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.querySelector(`.skip-link`);e&&e.addEventListener(`keydown`,()=>{})})();"],["D:/best/fata.worktrees/existential-questions/src/components/ui/Modal.astro?astro&type=script&index=0&lang.ts","{let e=document.querySelector(`[data-testid=\"${testId}\"]`),t=document.querySelector(`[data-testid=\"${testId}-close\"]`),n=document.querySelector(`[data-testid=\"${testId}-backdrop\"]`);function r(){e?.classList.add(`hidden`),document.body.style.overflow=``}t?.addEventListener(`click`,r),n?.addEventListener(`click`,()=>closeOnOverlayClick&&r()),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&closeOnEscape&&r()})}"],["D:/best/fata.worktrees/existential-questions/src/components/Search.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelector(`input[type=\"search\"]`),n=e.querySelector(`[data-search-clear]`),r=e.querySelector(`[role=\"listbox\"]`),i=e.querySelectorAll(`[data-suggestion-value]`),a;function o(e){let t=e.target,i=t.value;n?.classList.toggle(`hidden`,!i),t.setAttribute(`aria-expanded`,r?.children.length?`true`:`false`),clearTimeout(a),a=setTimeout(()=>{onSearch&&onSearch(i)},300)}function s(){t&&(t.value=``,t.focus()),n?.classList.add(`hidden`),onClear&&onClear(),onSearch&&onSearch(``)}function c(e){let n=e.currentTarget.getAttribute(`data-suggestion-value`);n&&t&&(t.value=n,t.focus(),onSearch&&onSearch(n)),r?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`)}function l(e){if(!r||r.classList.contains(`hidden`))return;let n=Array.from(r.querySelectorAll(`[data-suggestion-value]`)),i=n.findIndex(e=>e===document.activeElement);switch(e.key){case`ArrowDown`:e.preventDefault(),n[(i+1)%n.length]?.focus();break;case`ArrowUp`:e.preventDefault(),n[(i-1+n.length)%n.length]?.focus();break;case`Enter`:i>=0&&(e.preventDefault(),n[i].click());break;case`Escape`:r.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`),t?.focus()}}t?.addEventListener(`input`,o),t?.addEventListener(`focus`,()=>{r?.children.length&&(r.classList.remove(`hidden`),t?.setAttribute(`aria-expanded`,`true`))}),t?.addEventListener(`keydown`,l),n?.addEventListener(`click`,s),i.forEach(e=>{e.addEventListener(`click`,c)}),document.addEventListener(`click`,n=>{e.contains(n.target)||(r?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`))})})();"],["D:/best/fata.worktrees/existential-questions/src/components/ui/Tabs.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelectorAll(`[data-tabs-trigger]`),n=e.querySelectorAll(`[data-tabs-panel]`);function r(e){t.forEach(t=>{let n=t.getAttribute(`data-tab`)===e;t.setAttribute(`aria-selected`,n.toString()),t.setAttribute(`tabIndex`,n?`0`:`-1`),n?(t.classList.add(`text-brand`,`border-b-2`,`border-brand`,`-mb-px`),t.classList.remove(`text-text-secondary`)):(t.classList.remove(`text-brand`,`border-b-2`,`border-brand`,`-mb-px`),t.classList.add(`text-text-secondary`))}),n.forEach(t=>{let n=t.getAttribute(`aria-labelledby`)?.includes(e);t.hidden=!n,n?(t.classList.remove(`hidden`),t.classList.add(`animate-fade-in`)):t.classList.add(`hidden`)})}t.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-tab`);t&&!e.disabled&&(r(t),onChange&&onChange(t))}),e.addEventListener(`keydown`,n=>{let r=Array.from(t).map(e=>e.getAttribute(`data-tab`)).filter(Boolean),i=r.indexOf(e.getAttribute(`data-tab`)||``);switch(n.key){case`ArrowRight`:n.preventDefault();let a=(i+1)%r.length;t[a]?.focus();break;case`ArrowLeft`:n.preventDefault();let o=(i-1+r.length)%r.length;t[o]?.focus();break;case`Home`:n.preventDefault(),t[0]?.focus();break;case`End`:n.preventDefault(),t[t.length-1]?.focus();break;case`Enter`:case` `:n.preventDefault(),e.click()}})})})();"],["D:/best/fata.worktrees/existential-questions/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts","(function(){function e(){return window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`}function t(){return localStorage.getItem(`theme-preference`)||`system`}let n=t(),r=n===`system`?e():n;document.documentElement.setAttribute(`data-theme`,r),document.documentElement.classList.toggle(`dark`,r===`dark`)})();"],["D:/best/fata.worktrees/existential-questions/src/components/ThemeToggle.astro?astro&type=script&index=1&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelector(`[data-theme-toggle]`),n=e.querySelector(`[data-theme-menu]`),r=e.querySelectorAll(`[data-theme-option]`),i={sun:t?.querySelector(`[data-theme-icon=\"sun\"]`),moon:t?.querySelector(`[data-theme-icon=\"moon\"]`),system:t?.querySelector(`[data-theme-icon=\"system\"]`)};function a(e){Object.values(i).forEach(e=>{e&&(e.classList.add(`-rotate-90`,`scale-0`),e.classList.remove(`rotate-0`,`scale-100`))});let t=i[e];t&&(t.classList.remove(`-rotate-90`,`scale-0`),t.classList.add(`rotate-0`,`scale-100`)),r.forEach(t=>{let n=t.getAttribute(`data-theme-option`)===e;t.setAttribute(`aria-checked`,n.toString())})}function o(e){if(document.documentElement.classList.add(`theme-switching`),e===`system`){let e=window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`;document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,e===`dark`)}else document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,e===`dark`);localStorage.setItem(`theme-preference`,e),requestAnimationFrame(()=>{document.documentElement.classList.remove(`theme-switching`)}),a(e)}o(localStorage.getItem(`theme-preference`)||`system`),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,e=>{localStorage.getItem(`theme-preference`)===`system`&&o(`system`)});function s(){n?.classList.contains(`hidden`)?(n?.classList.remove(`hidden`),t?.setAttribute(`aria-expanded`,`true`)):(n?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`))}t?.addEventListener(`click`,e=>{e.stopPropagation(),s()}),r.forEach(e=>{e.addEventListener(`click`,()=>{o(e.getAttribute(`data-theme-option`)),n?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`)})}),document.addEventListener(`click`,r=>{e.contains(r.target)||(n?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`))}),t?.addEventListener(`keydown`,e=>{e.key===`Enter`||e.key===` `?(e.preventDefault(),s()):e.key===`Escape`&&(n?.classList.add(`hidden`),t?.setAttribute(`aria-expanded`,`false`))}),t?.addEventListener(`dblclick`,()=>{let e=[`light`,`dark`,`system`],t=localStorage.getItem(`theme-preference`)||`system`;o(e[(e.indexOf(t)+1)%e.length])})})();"],["D:/best/fata.worktrees/existential-questions/src/components/ui/Tooltip.astro?astro&type=script&index=0&lang.ts","(function(){let e=document.currentScript?.parentElement;if(!e)return;let t=e.querySelector(`slot`)?.assignedElements()[0]||e.firstElementChild,n=e.querySelector(`[data-tooltip]`),r;function i(){clearTimeout(r),r=setTimeout(()=>{n?.classList.remove(`opacity-0`,`invisible`),n?.classList.add(`opacity-100`,`visible`)},delay)}function a(){clearTimeout(r),n?.classList.remove(`opacity-100`,`visible`),n?.classList.add(`opacity-0`,`invisible`)}t?.addEventListener(`mouseenter`,i),t?.addEventListener(`mouseleave`,a),t?.addEventListener(`focus`,i),t?.addEventListener(`blur`,a)})();"]],"assets":["/favicon.svg","/_astro/keystatic-page.lsjIxpR9.js","/_astro/Layout.BYRzo9Xt.css","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"ULIhS3KiZZgA2BfjBrz3Gwau3cHJts7Pm+vWPl9GLoQ=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "75352967-25d5-4b9d-92cb-1f8947be6c9a") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
